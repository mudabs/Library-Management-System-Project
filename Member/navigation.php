...
<body>
    <header class="reg_header">
        <span class = "reg_logo">
           <h3 style="color:white; float: left;padding-top: 20px; padding-left:10px;">LIBRARY MANAGEMENT SYSTEM</h3>
        </span>
        <?php
            ...
            else
            {
                ...
                <nav class = "sign">
                    <ul>
                        <li><a href="member_login.php" ><span class = "glyphicon glyphicon-log-in"></span>_LOGIN</a></li>
