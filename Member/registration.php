...
-->
                        ...
                        <br>
                        <p style=" color:white">
                        Already have an Account? <a href="member_login.php" class = "sign_icon">Sign In</a> 
                        </p>
                    </form>
                </div>
    ...
    <?php
        if(isset($_POST['submit']))
        {
            ...
            $sql="SELECT username FROM member"; //works the same way as the mysqli_query method
            ...
            if($count == 0)
            {
                //SQL code for inserting values
                 mysqli_query($db,"INSERT INTO `member` VALUES ('$_POST[firstname]', 
